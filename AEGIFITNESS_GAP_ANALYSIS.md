...
11. **Reporte semanal automático**
    ...
    - Generación automática dentro de la aplicación.
    - Reutilizar el exportador actual para HTML, Markdown y PDF.

### P2 — Nutrición y estilo de vida

12. **Alimentos y recetas personales reutilizables**
    - Convertir entradas rápidas en alimentos guardados.
    - Crear y editar recetas con ingredientes, porciones y macros.
    - Favoritos, comidas frecuentes y plantillas.

13. **Copiar comidas y duplicar días**
    - Copiar una comida anterior.
    - Duplicar el registro o el plan completo de otro día.
    - Reducir el trabajo repetitivo del usuario.

14. **Lista de compras automática**
    - Consolidar ingredientes de un período.
    - Agrupar por categoría y sumar cantidades compatibles.
    - Permitir marcar productos y exportar la lista.

15. **Sustituciones nutricionales más precisas**
    - Comparar calorías, proteína, carbohidratos, grasas, azúcares y porciones.
    - Explicar qué cantidad del sustituto conserva mejor el objetivo.
    - Incorporar preferencias, alergias o ingredientes excluidos.

16. **Cardio como dominio propio**
    - Caminata, carrera, bicicleta, natación, senderismo y yoga.
    - Tiempo, distancia, ritmo, calorías y frecuencia cardíaca opcional.

17. **Agua, pasos y actividad diaria**
    - Metas y registros diarios.
    - Gráficas, rachas y adherencia independientes.

18. **Recuperación**
    - Sueño, energía, dolor muscular, estrés y motivación.
    - Recomendaciones prudentes sin presentarlas como diagnóstico médico.

19. **Rachas separadas y tolerantes al descanso**
    - Entrenamiento, nutrición, peso, agua, pasos y consistencia general.
    - Descansos programados que no rompan la racha.

### P3 — Inteligencia y ecosistema

20. **Adaptación automática de entrenamiento y nutrición**
    - Ajustar series, repeticiones, descansos y ejercicios según rendimiento.
    - Ajustar calorías y macros según tendencia corporal y adherencia.
    - Mostrar explicación y solicitar confirmación antes de modificar el plan.

21. **Aegi Coach con IA**
    - Respuestas basadas exclusivamente en datos autorizados del usuario.
    - Resúmenes, alternativas para casa y sesiones reducidas.
    - Límites explícitos frente a temas médicos y decisiones de riesgo.

22. **Integraciones de salud y wearables**
    - Pasos, frecuencia cardíaca, sueño y entrenamientos externos.
    - Diseñar primero permisos, procedencia de datos, deduplicación y privacidad.

## Orden recomendado de próximas entregas

1. **Entrenamiento 2.0:** series individuales, sesión móvil, duración e historial por ejercicio.
2. **Progreso 2.0:** PR, 1RM, medidas corporales, adherencia real y comparaciones.
3. **Calendario y offline:** actividad diaria unificada y registro confiable sin señal.
4. **Nutrición 2.0:** recetas personales, favoritos, duplicación y compras.
5. **Lifestyle:** cardio, agua, pasos, recuperación y rachas específicas.
6. **Inteligencia:** progressive overload, adaptación automática y finalmente Aegi Coach.

## Conclusión

AegiFitness ya es un planificador y registrador fitness funcional con nutrición, métricas, gamificación, exportación y consulta. Todavía no es un sistema completo de progresión porque le falta granularidad histórica, especialmente por serie y por ejercicio.

La siguiente inversión no debería ser IA. Debería ser **Entrenamiento 2.0 + Progreso 2.0**. Esa base convierte los registros actuales en datos confiables y habilita casi todo lo avanzado de la conversación original.
